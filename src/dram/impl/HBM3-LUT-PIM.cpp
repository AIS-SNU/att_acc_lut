...
class HBM3PIM : public IDRAM, public Implementation {
  ...
  public:
    ...
    inline static const std::map<std::string, std::vector<int>> timing_presets = {
      ...
      // EEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEEE
      // nCCDAB를 적당한 parameter로 환산해서 넣으면 됩니다.
      // HBM3_5.2GBps 쓰고 있으니 그것만 수정하면 되요!
      // 현재 설정은 1200ps x 6 cycle = 7.2 ns 마다 수행 가능한 setup!
      ...
      // <--------------- 이 라인!                                                                                   여기!!!!! (12그냥 아무 값이나 해논것!)
      {"HBM3_LUT_5.2Gbps", {5200,   2,  19,   19,     19,    19,   45,  63,  21,    6,     8,    6,    2,      4,     12,      6,      2,     4,     8,    11,    3,    39,   -1,   260,   5070,     -1,     11,   1300}},
  ...
  private:
    ...
    void set_timing_vals() {
      ...
      populate_timingcons(this, {
          ...
          // <---------------------- 이게 MAC 간의 간격 이니까 nCCDAB값만 수정하면 됨!!!!!
